						...
						<div className='flex flex-col gap-12'>
							...
							<div className={shouldShowTab('providers') ? `` : 'hidden'}>
								<ErrorBoundary>
									...
									<h3 className={`text-void-fg-3 mb-2`}>{`Void can access models from Anthropic, OpenAI, and more.`}</h3>
											...
											<div>
												...
												<div className='text-sm text-void-fg-3 mt-1'>
													...
													<span
														...
														data-tooltip-id='void-tooltip'
														data-tooltip-content='We recommend using FIM-capable models for autocomplete.'
