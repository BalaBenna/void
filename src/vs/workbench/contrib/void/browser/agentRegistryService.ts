...
const builtinAgents: VoidAgentDefinition[] = [
	...
	// AI Team Role agents
	{
		...
		description: 'Reviews code for OWASP Top 10 vulnerabilities, injection risks, auth issues, and sensitive data exposure.',
		source: 'builtin',
		model: 'inherit',
		tools: null,
		readonly: true,
		...
		timeout: 180_000,
		maxIterations: 15,
		systemPrompt: 'You are a security review agent. Analyze the given code for OWASP Top 10 vulnerabilities including: injection (SQL, XSS, command), broken authentication, sensitive data exposure, XXE, broken access control, security misconfiguration, insecure deserialization, and insufficient logging. Report findings with severity, location, and remediation steps.',
		filePath: null,
	},
	{
		id: 'test-writer',
		name: 'Test Writer',
		description: 'Generates unit, integration, and e2e tests for code. Covers edge cases and error paths.',
		source: 'builtin',
		model: 'inherit',
		tools: null,
		readonly: false,
		...
		timeout: 180_000,
		maxIterations: 20,
		systemPrompt: 'You are a test generation agent. Write comprehensive tests for the given code. Include unit tests, edge cases, error handling tests, and boundary conditions. Use the testing framework already present in the project. Aim for high code coverage.',
		filePath: null,
	},
	{
		id: 'docs-writer',
		name: 'Docs Writer',
		description: 'Updates JSDoc comments, README files, and inline documentation.',
		source: 'builtin',
		model: 'inherit',
		tools: null,
		readonly: false,
		...
		timeout: 120_000,
		maxIterations: 15,
		systemPrompt: 'You are a documentation agent. Add or update JSDoc/TSDoc comments, README sections, and inline documentation for the given code. Follow the existing documentation style in the project.',
		filePath: null,
	},
	{
		id: 'perf-analyzer',
		name: 'Performance Analyzer',
		description: 'Detects N+1 queries, missing indexes, memory leaks, and performance bottlenecks.',
		source: 'builtin',
		model: 'inherit',
		tools: null,
		readonly: true,
		...
		timeout: 180_000,
		maxIterations: 15,
		systemPrompt: 'You are a performance analysis agent. Review the given code for: N+1 query patterns, missing database indexes, unnecessary re-renders, memory leaks, excessive allocations, blocking operations on main thread, inefficient algorithms, and missing caching opportunities. Report findings with impact assessment and optimization suggestions.',
		filePath: null,
	},
];
