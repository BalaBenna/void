...
import { RefreshableProviderName, RefreshableProviderName as _RefreshableProviderName } from './voidSettingsTypes.js';
...
export class RefreshModelService extends Disposable implements IRefreshModelService {
	...
	state: RefreshModelStateOfProvider = {} as RefreshModelStateOfProvider
	...
	startRefreshingModels: IRefreshModelService['startRefreshingModels'] = (providerName, options) => {
		// No-op as local models are removed
	}
}
