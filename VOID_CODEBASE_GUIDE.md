...
Sending LLM messages from the main process avoids CSP issues and lets us use node_modules more easily.
...
- **ProviderName**: The name of a provider: `'openAI'`, `'anthropic'`, etc.
